...
employeedata = os.path.join("LearnPython","PythonHW","Python-Challenge","employee_data_1.csv")
...
# Set empty list variables
    ...
    State = []
#open current csv
with open(employeedata,'r',encoding="utf-8")
csvfile:
...
#zip lists together
    ...
    csvwriter.writerrow(["Emp_ID","First_Name","Last_Name", "DOB", "SSN", "State")
    ])
